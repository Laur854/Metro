...
/**
 * Implementation of {@link RegularAssert}. When the assert fails it will take a snapshot and log to the report
 * and log file.
 */
public class ScreenshotAssertImpl implements RegularAssert {
    ...
    public void isTrue(
        ...
        try {
            ...
            throw new SeleniumException(composeMessage(e, description), e);
        }
    }
